...
Static website for Weino app, containing Privacy Policy, Terms of Service, Support/FAQ, and homepage.
...
2. **Update HTML** in all files:
   ...
   <!-- With this -->
   <div class="logo">
     <img src="logo.png" alt="Weino" style="width: 100px; height: 100px;">
   </div>
   ```
